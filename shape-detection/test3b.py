...
while(True):
    ...
    for c in cnts:
            ...
            if M["m00"] > 0:
                ...
                if(area>20):#this is to draw the contours for the town hall
                ...
                if(area2>17):
                    if(shape2=='circle' or shape2=='square' or shape2=='rectangle' or shape2=='triangle'):
                        if(area2>255):   
                            ...
                            cv2.line(resized,(cX,cY),(cX2,cY2),(255,cyan,0),2)#draws line from one point ti the other, last arg means thickness
                            cyan=cyan-1
                            print(cX2,cY2)
